...
class TestEmail(BaseTest):
    ...
    scenarios = [
        ...
        *all_fails(
        ...
        # FIXME
        *xpass(scenarios=[
            ("11111111112222222222333333333344444444445555555555666666666677777@example.com", "11111111112222222222333333333344444444445555555555666666666677777@example.com"),
            ("111111111122222222223333333333444444444455555555556666666666777777@example.com", "111111111122222222223333333333444444444455555555556666666666777777@example.com"),
        ], reason="Pydantic do not use 'strict' so this currently pass"),
        # multiple
        *nones(*MULTIPLE_NONISH, output="", raw_option={"multiple": True}),

...
def regen_conf(
    ...
    if os.path.exists("/etc/yunohost/installed"):
        ...
        env["YNH_DOMAINS_WITH_MAIL_IN"] = " ".join(domain_list(features=["mail_in"])["domains"])
        env["YNH_DOMAINS_WITH_MAIL_IN_AND_OUT"] = " ".join(domain_list(features=["mail_in", "mail_out"])["domains"])

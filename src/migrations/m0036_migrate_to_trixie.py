...
class MyMigration(Migration):
    ...
    def run(self) -> None:
        ...
        download_gpg_key(
            ...
            Path("/usr/share/keyrings/yunohost-trixie.gpg"),
        )
        ...
        download_gpg_key(
            ...
            Path("/usr/share/keyrings/sury_php.gpg"),
        )
        ...
        for filename in ["extra_php_version.list", "yarn.list"]:
            legacy_file: Path = Path("/etc/apt/sources.list.d") / filename
            if legacy_file.exists():
                logger.warning(m18n.n("migration_0036_apt_lists_file_still_exists", file=str(legacy_file)))
                legacy_file.rename(legacy_file.with_name(legacy_file.name + ".legacy_bookworm"))
        ...
        for file in deb822s:
            ...
            for paragraph in paragraphs:
                ...
                if re.match(
                    ...
                    paragraph["Signed-By"] = "/usr/share/keyrings/yunohost-trixie.gpg"

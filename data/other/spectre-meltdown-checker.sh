...
# Message from YunoHost team:
# this is this version https://github.com/speed47/spectre-meltdown-checker/blob/dce917bfbb4fa5e135b7ed4c84881086766be802/spectre-meltdown-checker.sh
# that is included here
# You can find the licence (GPLv2))and author name in this script
